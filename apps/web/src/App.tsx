      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-6">
        ...
        <header className="text-center mb-14 space-y-4 animate-fadeIn">
          ...
          <p className="text-gray-300 text-base md:text-lg max-w-2xl mx-auto leading-relaxed pt-2">
            The address you submit will be encrypted in the browser and decrypted offline by the round
            administrator, who will send to that address: your Voting NFT, gas money & 46 FINN. FINN tokens
            will be worth 1 Finney (0.001 ETH) if donated in the QF round.
          </p>
